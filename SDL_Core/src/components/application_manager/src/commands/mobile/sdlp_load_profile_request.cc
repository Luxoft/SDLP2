...
LoadProfileRequest::LoadProfileRequest(const MessageSharedPtr& message)
    : CommandRequestImpl(message)
{
}

LoadProfileRequest::~LoadProfileRequest()
{
}

void LoadProfileRequest::Run()
{
    LOG4CXX_INFO(logger_, "LoadProfileRequest::Run");
    ...
    ProfileManagerResult result = mgr->loadProfile(appID, profileName);
