...
-(id) init {
    ...
    functionIDs = [[NSDictionary dictionaryWithObjectsAndKeys:
                      ...
                      IVI_NAMES_addProfile, @"32762",
                      IVI_NAMES_removeProfile, @"32763",
                      IVI_NAMES_loadProfile, @"32764",
                      IVI_NAMES_unloadProfile, @"32765",
                      IVI_NAMES_sendAppToProfile, @"32766",
                      IVI_NAMES_appStateChanged, @"32767",
                   
                      IVI_NAMES_onProfileToApp, @"65534",
                      IVI_NAMES_onProfileClosed,@"65535",
                      nil] retain];
    }
