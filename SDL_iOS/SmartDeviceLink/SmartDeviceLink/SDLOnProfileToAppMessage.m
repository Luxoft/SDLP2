...
-(NSData*)messageData {
    return [self getBulkData];
}
- (void)setMessageDataToString:(NSString *)messageDataToString {
    [self setBulkData: [messageDataToString dataUsingEncoding: NSUTF8StringEncoding]];
}

-(NSString*)messageDataToString {
    return  [[[NSString alloc] initWithData:[self getBulkData] encoding:NSUTF8StringEncoding] autorelease];
}
@end
